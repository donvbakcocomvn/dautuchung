...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th8 22, 2022 lúc 08:18 AM
...
('f41131eb-fbe3-4236-bc97-becca32a344e', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'Phone', '0123456789', '2022-01-05 00:16:50', '2022-04-27 08:27:53', 0),
...
('5a761ea0-7bee-434d-80c6-36aefceb1d3d', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'CongTy', 'VN', '2022-01-05 02:29:12', '2022-04-27 08:27:53', 0),
...
('68a5939f-c6fc-43bf-bf13-a0904005c7aa', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'GioiTinh', '1', '2022-01-05 02:56:21', '2022-04-27 08:27:53', 0),
('0f2f4a16-d7e0-4766-bb32-2be6f05fc7b7', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'CCCD', 'Acb', '2022-01-05 02:57:44', '2022-04-27 08:27:53', 0),
('2e69c2ae-2a70-480c-8159-83c11f289988', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'NgayVaoLam', '2018-08-01', '2022-01-05 02:59:29', '2022-04-27 08:27:53', 0),
...
('355a84c3-12d1-4cfd-b012-57003debeb81', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'SoHopDong', '12312312312', '2022-01-05 03:12:40', '2022-04-27 08:27:53', 0),
('cda54283-ee57-44a9-aac0-fe754680c8c0', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'ThoiHangHopDong', '2', '2022-01-05 03:12:40', '2022-04-27 08:27:53', 0),
('b7f3c9bf-f483-4eef-a4ab-1df858f2e6d9', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'NgayKyHopDong', '2022-01-01', '2022-01-05 03:12:40', '2022-04-27 08:27:53', 0),
('fed45495-0f11-496c-9420-b8345af2066d', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'TinhTrangHD', '1', '2022-01-05 03:17:59', '2022-04-27 08:27:53', 0),
...
('a2771da0-f58b-431c-a216-e64cc19beb45', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'HoChieu', '', '2022-01-11 03:55:18', '2022-04-27 08:27:53', 0),
...
('cd3d39ac-9e07-457f-b268-cfb1a9d957e9', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'CMND', '', '2022-01-11 04:45:54', '2022-04-27 08:27:53', 0),
...
('448e4376-0047-4532-baee-ce6e35a4f842', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'HinhNhanVien', '/public/userfiles/admin/images/product12.jpg', '2022-04-27 08:26:51', '2022-04-27 08:27:53', 0),
('44065390-6234-4ace-b43d-333b52625acb', '78f8358e-3e33-11ec-ad78-0cc47acc8ffc', 'MaNhanVien', '', '2022-04-27 08:26:51', '2022-04-27 08:27:53', 0);
...
--
-- Chỉ mục cho bảng `lap1_lang`
--
ALTER TABLE `lap1_lang`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_locations`
--
ALTER TABLE `lap1_locations`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_menu`
--
ALTER TABLE `lap1_menu`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_news`
--
ALTER TABLE `lap1_news`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_news_duan`
--
...
--
-- Chỉ mục cho bảng `lap1_nhanvien_lichlamviec`
--
...
--
-- Chỉ mục cho bảng `lap1_nhanvien_lichlamviec_calamviec`
--
ALTER TABLE `lap1_nhanvien_lichlamviec_calamviec`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_options`
--
...
--
-- Chỉ mục cho bảng `lap1_pages`
--
ALTER TABLE `lap1_pages`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_role`
--
ALTER TABLE `lap1_role`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_sanpham`
--
ALTER TABLE `lap1_sanpham`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_sanpham_danhmuc`
--
ALTER TABLE `lap1_sanpham_danhmuc`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_sanpham_donhang`
--
...
--
-- Chỉ mục cho bảng `lap1_sanpham_donhang_chitiet`
--
...
--
-- Chỉ mục cho bảng `lap1_sanpham_options`
--
...
--
-- Chỉ mục cho bảng `lap1_sanpham_options_soluong`
--
...
--
-- Chỉ mục cho bảng `lap1_sanpham_options_type`
--
ALTER TABLE `lap1_sanpham_options_type`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_sanpham_thuoctinh`
--
...
--
-- Chỉ mục cho bảng `lap1_sanpham_thuoctinh_chitiet`
--
ALTER TABLE `lap1_sanpham_thuoctinh_chitiet`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_slider`
--
ALTER TABLE `lap1_slider`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_users`
--
...
--
-- Chỉ mục cho bảng `lap1_users_baocao`
--
ALTER TABLE `lap1_users_baocao`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `lap1_users_infor`
--
...
--
-- Chỉ mục cho bảng `lap1_users_role`
--
...
--
-- AUTO_INCREMENT cho bảng `lap1_locations`
--
ALTER TABLE `lap1_locations`
