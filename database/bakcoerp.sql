...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 04, 2022 at 09:53 AM
...
CREATE TABLE IF NOT EXISTS `lap1_users_infor` (
  `IdUser` varchar(50) COLLATE utf8_german2_ci NOT NULL,
  `Keyword` varchar(50) COLLATE utf8_german2_ci NOT NULL,
  `Val` text COLLATE utf8_german2_ci DEFAULT NULL,
  `CreateDate` datetime NOT NULL,
  `UpdateDate` datetime NOT NULL,
  `isDelete` int(11) NOT NULL,
  PRIMARY KEY (`IdUser`,`Keyword`)
